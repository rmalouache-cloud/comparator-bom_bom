...
if start:
    ...
    # =========================
    # 🔥 IMPORTANT : PAS DE GROUPBY / PAS DE SUM
    # =========================
    old = old.copy()
    new = new.copy()
    ...
    result["Desc OLD"] = result.get("Description", "")
    result["Desc NEW"] = result.get("Description", "")

    result["Pos OLD"] = result["Position"]
    result["Pos NEW"] = result["Position"]
